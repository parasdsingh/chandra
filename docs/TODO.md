...
| # | Task | Status | Notes |
|---|---|---|---|
| 1.1 | ~~**Sidereal ascendant in the engine**~~ | done | The blocker. `swe_houses_ex` with `SEFLG_SIDEREAL`, named-field request struct so the arguments cannot be transposed. §2.2 |
